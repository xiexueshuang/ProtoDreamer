...
def create_ui():
        ...
        with FormRow().style(equal_height=False):
            with gr.Column(variant='compact', elem_id="img2img_settings"):
                ...
                with gr.Tabs(elem_id="mode_img2img"):
                    with gr.TabItem('输入', id='img2img', elem_id="img2img_img2img_tab") as tab_img2img:
                        with gr.Column(scale=1, elem_id=f"mode_img2img"):
                ...
                for category in ordered_ui_categories():
                    if category == "sampler":
                        ...
                        with FormGroup():
                            ...
                            denoising_strength = gr.Slider(value=0.55, minimum=0.0, maximum=1.0, step=0.01, label='图片相似度', elem_id="img2img_denoising_strength", visible=True)
    ...
    interfaces = [
        ...
        (img2img_interface, "图片生成", "img2img"),
