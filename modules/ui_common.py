...
""", file=sys.stderr)
    ...
    with gr.Column(variant='panel', elem_id=f"{tabname}_results", scale=1.7):
        with gr.Group(elem_id=f"{tabname}_gallery_container"):
            result_gallery = gr.Gallery(label='Output', show_label=True, elem_id=f"{tabname}_gallery").style(grid=4, row = 4, preview=True, height=2000, container = True)
