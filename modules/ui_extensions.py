...
def create_ui():
    ...
    with gr.Blocks(analytics_enabled=True) as ui:
        with gr.Tabs(elem_id="tabs_extensions", visible=True) as tabs:
            with gr.TabItem("Installed"):
                ...
                with gr.Row(elem_id="extensions_installed_top"):
                    ...
                    extensions_disabled_list = gr.Text(elem_id="extensions_disabled_list", visible=True).style(container=False)
                    extensions_update_list = gr.Text(elem_id="extensions_update_list", visible=True).style(container=False)
    ...
    "Disable all extensions" was set, change it to "none" to load all extensions again
            ...
            with gr.TabItem("Available"):
                with gr.Row():
                    ...
                    extension_to_install = gr.Text(elem_id="extension_to_install", visible=True)
                    install_extension_button = gr.Button(elem_id="install_extension_button", visible=True)
